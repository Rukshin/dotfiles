...
return {
  {
    ...
    config = function()
      ...
      -- runs alongside kotlin_lsp; all capabilities except codeAction are disabled to avoid conflicts
      -- requires classpath.txt in project root — generate with: dot kotlin generate-classpath
      vim.lsp.config.kotlin_language_server = {
        ...
        on_init = function(client)
          -- disable everything except code actions to avoid conflicts with kotlin_lsp
